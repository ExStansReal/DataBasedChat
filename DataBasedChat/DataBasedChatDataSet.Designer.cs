...
SELECT ID_Zayavki, User_ID_From, User_ID_To, Date FROM Zayavki WHERE (ID_Zayavki = @ID_Zayavki)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO [dbo].[Zayavki] ([User_ID_From], [User_ID_To], [Date]) VALUES (@User_" +
                "ID_From, @User_ID_To, @Date);\r\nSELECT ID_Zayavki, User_ID_From, User_ID_To, Date" +
                " FROM Zayavki ";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@User_ID_From", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "User_ID_From", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@User_ID_To", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "User_ID_To", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
